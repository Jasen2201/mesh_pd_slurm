#!/usr/bin/env bash
#SBATCH --job-name=m3-tp4-eager-f1c1
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/m3_tp4_eager_f1c1-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/m3_tp4_eager_f1c1-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_minimax_logs/$(date +%m%d)_m3_tp4_eager_f1c1_${SLURM_JOB_ID}}"

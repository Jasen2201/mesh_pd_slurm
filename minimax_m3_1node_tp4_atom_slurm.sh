#!/usr/bin/env bash
#SBATCH --job-name=minimax-m3-1node-tp4-atom
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1node_tp4_atom-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1node_tp4_atom-%j.err
#

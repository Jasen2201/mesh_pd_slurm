#!/usr/bin/env bash
#SBATCH --job-name=minimax-m3-1p1d-tp4-eagle3-decode-noquant
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1p1d_tp4_eagle3_decode_noquant-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1p1d_tp4_eagle3_decode_noquant-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_minimax_logs/$(date +%m%d)_minimax_m3_1p1d_tp4_eagle3_decode_noquant_${SLURM_JOB_ID}}"

#!/usr/bin/env bash
#SBATCH --job-name=minimax-m3-1node-tp4-fusion0
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1node_tp4_fusion0-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1node_tp4_fusion0-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_minimax_logs/$(date +%m%d)_minimax_m3_1node_tp4_fusion0_${SLURM_JOB_ID}}"

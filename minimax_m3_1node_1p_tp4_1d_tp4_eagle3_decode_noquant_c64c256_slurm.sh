#!/usr/bin/env bash
#SBATCH --job-name=m3-1p1d-eagle3-noquant-c64c256
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/m3_1p1d_eagle3_noquant_c64c256-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/m3_1p1d_eagle3_noquant_c64c256-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_minimax_logs/$(date +%m%d)_m3_1p1d_eagle3_noquant_c64c256_${SLURM_JOB_ID}}"

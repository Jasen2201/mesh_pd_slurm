#!/usr/bin/env bash
#SBATCH --job-name=minimax-m3-1node-tp8-atom-dpa-g47
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1node_tp8_atom_dpa_g47-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_1node_tp8_atom_dpa_g47-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_minimax_logs/$(date +%m%d)_minimax_m3_1node_tp8_atom_dpa_g47_${SLURM_JOB_ID}}"

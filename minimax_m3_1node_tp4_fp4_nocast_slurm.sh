#!/usr/bin/env bash
#SBATCH --job-name=minimax-m3-tp4-fp4-nocast
...
#SBATCH --output=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_tp4_fp4_nocast-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_minimax_logs/minimax_m3_tp4_fp4_nocast-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_minimax_logs/$(date +%m%d)_minimax_m3_tp4_fp4_nocast_${SLURM_JOB_ID}}"
